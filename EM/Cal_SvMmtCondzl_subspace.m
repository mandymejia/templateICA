function [miu_svq_fixzq, miu_svq2_fixzq] = Cal_SvMmtCondzl_subspace( miu_svq_condz , miu_svq2_condz, PostProbz, idx, M, Q2, q2)
...
miu_svq_fixzq  = 0;
miu_svq2_fixzq = 0;
ID = idx; %indices of dictionary that have z_q==m
