...
%% CONNECTOGRAM SPATIAL MAPS WIDTH
global CONNECTOGRAM_SM_WIDTH;

%% CONNECTOGRAM Figure Position
...
TIMECOURSE_POSTPROCESS.spectra.sampling_frequency = 1/EXPERIMENTAL_TR;
TIMECOURSE_POSTPROCESS.spectra.frequency_band = [0, 1/(2*EXPERIMENTAL_TR)];
