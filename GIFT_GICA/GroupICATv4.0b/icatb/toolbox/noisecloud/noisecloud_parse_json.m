function [data json] = noisecloud_parse_json(json)
% Modified for noisecloud, original file courtesy of:
% http://www.mathworks.com/matlabcentral/fileexchange/20565-json-parser/content/parse_json.m
